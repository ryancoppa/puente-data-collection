...
export class VisualChartsPage {
  ...
  ionViewDidLoad() {
    ...
    this.barChart = new Chart(this.barCanvas.nativeElement, {
      ...
      type: 'bar',
      data: {
          labels: ["Community 1", "Community 2", "Community 3", "Community 4", "Community 5", "Community 6"],
          datasets: [{
              label:'Communities',
              data: [12, 19, 3, 5, 2, 3],
              backgroundColor: [
  ...
  this.doughnutChart = new Chart(this.doughnutCanvas.nativeElement, {
      ...
      type: 'doughnut',
      data: {
          labels: ["Daily", "Weekly", "BiWeekly", "Every Three Weeks", "Monthly", "BiMonthly"],
          datasets: [{
